#!/usr/bin/env node
// DECLARES-COMPARES: {"repositoryHolds":["scripts/package-lock.json engine version","data-engine-version=\"current\" spans on pages"],"worldSource":"npmjs.org dist-tags.latest for @observer-protocol/policy-engine","goesStaleWhen":"the latest dist-tag moves"}
